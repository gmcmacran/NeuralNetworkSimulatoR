...
The structure of the underlying network will be 3 hidden layers. The fist two hidden layers will have 10 nodes. The last hidden layers will have 5 nodes.
...
A data set with a thousand rows is created.
